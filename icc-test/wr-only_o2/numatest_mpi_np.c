...
/*			if(i == (total_numa_nodes-1)){
				...
				a = (double*)numa_alloc_onnode(size, numa_node_ids[0]);
				b = (double*)numa_alloc_onnode(size, numa_node_ids[0]);
				c = (double*)numa_alloc_onnode(size, numa_node_ids[0]);
				d = (double*)numa_alloc_onnode(size, numa_node_ids[0]);
				e = (double*)numa_alloc_onnode(size, numa_node_ids[0]);
//			}
